...
<div id="section3" class="container-fluid">
  <div class="container">
    ...
    <div class="w3-row w3-center">
          ...
          <div class="w3-row">
            <div class="w3-col s6 w3-center">
              <div class="w3-card-4" style="width:100%">
                <img src="{{ asset('avatares/avatar-12.png')}}" alt="Norway" style="width:100%">
            ...
            <div class="w3-col s6 w3-center">
              <div class="w3-card-4" style="width:100%">
                <img src="{{ asset('avatares/avatar.png')}}" alt="Norway" style="width:100%">
                <div class="w3-container w3-center">
      ...
      <div class="w3-col l4  w3-center">
        <div class="w3-container">
          ...
          <div class="w3-row">
            <div class="w3-col s6 w3-center">
              <div class="w3-card-4" style="width:100%">
                <img src="{{ asset('avatares/avatar-1.png')}}" alt="Norway" style="width:100%">
                <div class="w3-container w3-center">
                  <p>Miguel Ibañez</p>
                </div>
              </div>
            ...
            <div class="w3-col s6 w3-center">
              <div class="w3-card-4" style="width:100%">
                <img src="{{ asset('avatares/avatar-2.png')}}" alt="Norway" style="width:100%">
                <div class="w3-container w3-center">
      ...
      <div class="w3-col l4  w3-center">
        <div class="w3-container">
          ...
          <div class="w3-row">
            <div class="w3-col s6 w3-center">
              <div class="w3-card-4" style="width:100%">
                <img src="{{ asset('avatares/avatar-7.png')}}" alt="Norway" style="width:100%">
                <div class="w3-container w3-center">
            ...
            <div class="w3-col s6 w3-center">
              <div class="w3-card-4" style="width:100%">
                <img src="{{ asset('avatares/avatar-23.png')}}" alt="Norway" style="width:100%">
                <div class="w3-container w3-center">
      ...
      <a href="#section41">
        <img class="iconc" src="{{ asset('imgs/flechaabajo.png')}}">
      </a>
      <br>
      <br>
      <br>
  ...
  <div class="container-icons">
    <a href="">
      <div class="row-icon icon1">
        <h4>Google+</h4>
        <label class="">
          <img class="label1" src="{{ asset('imgs/google-plus.png')}}">
        </label>
      </div>
    </a>
    <a href="">
      <div class="row-icon icon2">
        <h4>Youtube</h4>
        <label class="">
          <img class="label2" src="{{ asset('imgs/youtube.png')}}">
        </label>
      </div>
    </a>
    <a href="">
      <div class="row-icon icon3">
        <h4>Instagram</h4>
        <label class="">
          <img class="label3" src="{{ asset('imgs/instagram.png')}}">
        </label>
      </div>
    </a>
    <a href="">
      <div class="row-icon icon4">
        <h4>Whatsapp</h4>
        <label class=" ">
          <img class="label4" src="{{ asset('imgs/whatsapp.png')}}">
        </label>
      </div>
    </a>
    <a href="">
      <div class="row-icon icon5">
        <h4>Facebook</h4>
        <label class=" ">
          <img class="label5" src="{{ asset('imgs/facebook.png')}}">
        </label>
      </div>
    </a>
    <a href="">
      <div class="row-icon icon6">
        <h4>Ubicacion</h4>
        <label class=" ">
          <img class="label6" src="{{ asset('imgs/location.png')}}">
        </label>
      </div>
    </a>

    <h2 class="iconop">
      <img src="{{ asset('imgs/phone-book.png')}}" style="width:50px;" </h2>
  </div>
